...
public class AssocRuleMining extends JFrame {
    ...
    public AssocRuleMining(String[] args) {
		...
		for(int index=0;index<args.length;index++) idArgument(args[index]);  //½âÎö²ÎÊý
...
public String getConsequentName(short consequentNumber) throws IOException{
    ...
    protected void outputItemSet(String[] itemSet) {
		// Check for empty set
		if (itemSet == null) System.out.print(" null ");
		// Process
		else {
    ...
    public void outputRules() throws IOException {
    ...
    public void outputRules(RuleNode ruleBinTree) throws IOException {
    ...
    private void outputRules2(RuleNode linkRuleNode) throws IOException {
		if (linkRuleNode != null) {
	    	// Left branch
    ...
    private void outputRule(RuleNode rule) throws IOException {
